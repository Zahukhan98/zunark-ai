...
import { FOUNDERS, COMPANY_LEGAL_NAME, COMPANY_ADDRESS } from "@/lib/content";
        ...
        <div className="mx-auto max-w-3xl px-6 pb-14 pt-20 sm:px-10 sm:py-14 print:px-0 print:py-0">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 text-sm">
            <div>
              ...
              {letter.sellerVatNumber && <div className="mt-1 text-gray-600">VAT Registration No: {letter.sellerVatNumber}</div>}
            </div>
            <div>
          ...
          <div className="mt-8 flex flex-col items-end gap-1 text-sm">
            ...
            {letter.sellerVatNumber && <div className="flex w-64 justify-between text-gray-600"><span>VAT registration</span><span>{letter.sellerVatNumber}</span></div>}
          </div>
          ...
          <div className="mt-16 grid grid-cols-3 gap-6">
            ...
            <div>
              <div className="h-20" />
              <div className="border-t pt-1 text-sm font-bold" style={{ borderColor: "#0f1b2d" }}>{letter.recipientName || "Client"}</div>
